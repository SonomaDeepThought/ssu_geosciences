...
import config1 # config file we need to load our params from
import config2 # config file we need to load our params from
import config3 # config file we need to load our params from
...
def parse_config_file1():
        loaded_params = {}
        loaded_params['model_name'] = config1.model_name
        loaded_params['num_epochs'] = config1.num_epochs
        loaded_params['batch_size'] = config1.batch_size
        loaded_params['ratio_train'] = config1.ratio_train
        loaded_params['ratio_test'] = config1.ratio_test
        loaded_params['learning_rate'] = config1.learning_rate
        loaded_params['output_directory'] = config1.output_directory
        loaded_params['optimizer'] = config1.optimizer
        loaded_params['image_directory'] = config1.image_directory
        loaded_params['num_gpus'] = config1.num_gpus
        return loaded_params
def parse_config_file2():
        loaded_params = {}
        loaded_params['model_name'] = config2.model_name
        loaded_params['num_epochs'] = config2.num_epochs
        loaded_params['batch_size'] = config2.batch_size
        loaded_params['ratio_train'] = config2.ratio_train
        loaded_params['ratio_test'] = config2.ratio_test
        loaded_params['learning_rate'] = config2.learning_rate
        loaded_params['output_directory'] = config2.output_directory
        loaded_params['optimizer'] = config2.optimizer
        loaded_params['image_directory'] = config2.image_directory
        loaded_params['num_gpus'] = config2.num_gpus
        return loaded_params
def parse_config_file3():
        loaded_params = {}
        loaded_params['model_name'] = config3.model_name
        loaded_params['num_epochs'] = config3.num_epochs
        loaded_params['batch_size'] = config3.batch_size
        loaded_params['ratio_train'] = config3.ratio_train
        loaded_params['ratio_test'] = config3.ratio_test
        loaded_params['learning_rate'] = config3.learning_rate
        loaded_params['output_directory'] = config3.output_directory
        loaded_params['optimizer'] = config3.optimizer
        loaded_params['image_directory'] = config3.image_directory
        loaded_params['num_gpus'] = config3.num_gpus
        return loaded_params
